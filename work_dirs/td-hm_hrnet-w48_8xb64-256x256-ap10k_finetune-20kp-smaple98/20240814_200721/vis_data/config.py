...
launcher = 'none'
load_from = 'models/_train-2024-08-14_19-59-59-real-sample98/best_coco_AP_epoch_170.pth'
log_level = 'INFO'
log_processor = dict(
...
test_evaluator = dict(
    ann_file='/workspace/datasets/cow-coco/annotations/20kp-sample98-test.json',
    type='CocoMetric')
...
val_dataloader = dict(
    ...
    sampler=dict(round_up=False, shuffle=False, type='DefaultSampler'))
val_evaluator = dict(
    ann_file='/workspace/datasets/cow-coco/annotations/20kp-sample98-val.json',
    type='CocoMetric')
val_pipeline = [
    dict(type='LoadImage'),
    dict(type='GetBBoxCenterScale'),
...
work_dir = './work_dirs/td-hm_hrnet-w48_8xb64-256x256-ap10k_finetune-20kp-smaple98'
