...
launcher = 'none'
load_from = 'models/_train-2024-08-15_05-25-27-real/best_coco_AP_epoch_200.pth'
log_level = 'INFO'
log_processor = dict(
...
test_evaluator = [
    ...
    outfile_prefix='test_annotations-real',
    type='CocoMetric'),
    dict(out_file_path='real.pkl', type='DumpResults'),
]
...
work_dir = 'models/_train-2024-08-15_05-25-27-real'
