...
launcher = 'none'
load_from = 'models/_train-2024-09-05_07-23-19-synthetic-varied-fold-4/best_coco_AP_epoch_70.pth'
log_level = 'INFO'
log_processor = dict(
...
val_dataloader = dict(
    batch_size=8,
    dataset=dict(
        ann_file='annotations/20kp-synthetic-varied-val-fold-4.json',
        data_mode='topdown',
        data_prefix=dict(img='20kp-synthetic-varied-data/'),
        data_root='/workspace/mmpose-synthetic-tune/datasets/',
        metainfo=dict(from_file='custom-configs/20kp.py'),
...
val_evaluator = dict(
    ann_file=
    '/workspace/mmpose-synthetic-tune/datasets/annotations/20kp-synthetic-varied-val-fold-4.json',
    type='CocoMetric')
val_pipeline = [
    dict(type='LoadImage'),
    dict(type='GetBBoxCenterScale'),
...
work_dir = 'models/_train-2024-09-05_07-23-19-synthetic-varied-fold-4'
