...
launcher = 'none'
load_from = 'models/_train-2024-08-30_19-32-14-synthetic-varied/epoch_210.pth'
log_level = 'INFO'
log_processor = dict(
...
test_evaluator = [
    dict(
        ...
        format_only=False,
        outfile_prefix='test_annotations-synthetic-varied',
        type='CocoMetric'),
...
work_dir = 'models/_train-2024-08-30_19-32-14-synthetic-varied'
