...
launcher = 'none'
load_from = 'models/_train-2024-09-03_17-59-35-synthetic-on-real-9/best_coco_AP_epoch_90.pth'
log_level = 'INFO'
log_processor = dict(
...
model = dict(
    ...
    init_cfg=dict(
        checkpoint=
        'models/_train-2024-09-03_15-23-46-real-simillar-9/best_coco_AP_epoch_100.pth',
        type='Pretrained'),
...
work_dir = 'models/_train-2024-09-03_17-59-35-synthetic-on-real-9'
