...
launcher = 'none'
load_from = 'models/_train-2024-09-04_16-09-04-real-simillar-8/best_coco_AP_epoch_50.pth'
log_level = 'INFO'
log_processor = dict(
...
train_dataloader = dict(
    batch_size=16,
    dataset=dict(
        ann_file='annotations/20kp-real-simillar-train-8.json',
        data_mode='topdown',
...
work_dir = 'models/_train-2024-09-04_16-09-04-real-simillar-8'
