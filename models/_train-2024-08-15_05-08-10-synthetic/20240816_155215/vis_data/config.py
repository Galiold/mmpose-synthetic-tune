...
launcher = 'none'
load_from = 'models/_train-2024-08-15_05-08-10-synthetic/best_coco_AP_epoch_50.pth'
log_level = 'INFO'
log_processor = dict(
...
test_evaluator = [
    dict(
        ...
        outfile_prefix='test_annotations-synthetic',
        type='CocoMetric'),
    dict(out_file_path='synthetic.pkl', type='DumpResults'),
]
train_cfg = dict(by_epoch=True, max_epochs=210, val_interval=10)
train_dataloader = dict(
    batch_size=16,
    dataset=dict(
        ann_file='annotations/20kp-synthetic-sample100-train.json',
        data_mode='topdown',
        data_prefix=dict(img='20kp-synthetic-data/'),
        data_root='/workspace/mmpose-synthetic-tune/datasets/',
        metainfo=dict(from_file='custom-configs/20kp.py'),
        pipeline=[
            dict(type='LoadImage'),
...
work_dir = 'models/_train-2024-08-15_05-08-10-synthetic'
