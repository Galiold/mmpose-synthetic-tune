...
launcher = 'none'
load_from = 'models/_train-2024-09-03_15-23-46-real-simillar-9/best_coco_AP_epoch_100.pth'
log_level = 'INFO'
log_processor = dict(
...
train_dataloader = dict(
    batch_size=16,
    dataset=dict(
        ann_file='annotations/20kp-real-simillar-train.json',
        data_mode='topdown',
...
val_dataloader = dict(
    batch_size=8,
    dataset=dict(
        ann_file='annotations/20kp-real-simillar-val.json',
        data_mode='topdown',
        data_prefix=dict(img='20kp-real-simillar-data/'),
        data_root='/workspace/mmpose-synthetic-tune/datasets/',
        metainfo=dict(from_file='custom-configs/20kp.py'),
...
val_evaluator = dict(
    ann_file=
    '/workspace/mmpose-synthetic-tune/datasets/annotations/20kp-real-simillar-val.json',
    type='CocoMetric')
val_pipeline = [
    dict(type='LoadImage'),
    dict(type='GetBBoxCenterScale'),
...
work_dir = 'models/_train-2024-09-03_15-23-46-real-simillar-9'
