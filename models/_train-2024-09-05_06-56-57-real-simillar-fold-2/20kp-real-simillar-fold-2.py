...
launcher = 'none'
load_from = 'models/_train-2024-09-05_06-56-57-real-simillar-fold-2/best_coco_AP_epoch_90.pth'
log_level = 'INFO'
log_processor = dict(
...
test_evaluator = [
    dict(
        ...
        format_only=False,
        outfile_prefix='test_annotations-real_simillar_fold',
        type='CocoMetric'),
...
train_dataloader = dict(
    batch_size=16,
    dataset=dict(
        ann_file='annotations/20kp-real-simillar-train-fold-2.json',
        data_mode='topdown',
...
work_dir = 'models/_train-2024-09-05_06-56-57-real-simillar-fold-2'
