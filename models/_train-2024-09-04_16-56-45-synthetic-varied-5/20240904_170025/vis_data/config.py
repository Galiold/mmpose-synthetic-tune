...
launcher = 'none'
load_from = 'models/_train-2024-09-04_16-56-45-synthetic-varied-5/best_coco_AP_epoch_60.pth'
log_level = 'INFO'
log_processor = dict(
...
val_dataloader = dict(
    batch_size=8,
    dataset=dict(
        ann_file='annotations/20kp-synthetic-varied-val-5.json',
        data_mode='topdown',
        data_prefix=dict(img='20kp-synthetic-varied-data/'),
        data_root='/workspace/mmpose-synthetic-tune/datasets/',
        metainfo=dict(from_file='custom-configs/20kp.py'),
...
val_evaluator = dict(
    ann_file=
    '/workspace/mmpose-synthetic-tune/datasets/annotations/20kp-synthetic-varied-val-5.json',
    type='CocoMetric')
val_pipeline = [
    dict(type='LoadImage'),
    dict(type='GetBBoxCenterScale'),
...
work_dir = 'models/_train-2024-09-04_16-56-45-synthetic-varied-5'
