...
launcher = 'none'
load_from = 'models/_train-2024-09-04_15-45-35-real-simillar-0/best_coco_AP_epoch_60.pth'
log_level = 'INFO'
log_processor = dict(
...
train_dataloader = dict(
    batch_size=16,
    dataset=dict(
        ann_file='annotations/20kp-real-simillar-train-0.json',
        data_mode='topdown',
...
work_dir = 'models/_train-2024-09-04_15-45-35-real-simillar-0'
